...
<script type="text/javascript">
    ...
    mainform.ligerForm({
        ...
        fields:[
            ...
            { display:'标题', name:'fldTitle', validate:{ required:true, maxlength:500 }, newline:true, type:"text", group:"基本信息", groupicon:'<c:url value="/static/ligerUI/icons/32X32/communication.gif"/>'},
