...
<script type="text/javascript">
    ...
    var grid = $("#maingrid").ligerGrid({
        columns:[
            ...
            { display:"值", name:"value", width:256, type:"text", editor:{ type:'text'} },
            { display:"状态", name:"status", width:100, type:"text", editor:{ type:'text'},
                render:function (item) {
                    if (parseInt(item.status) == 0) return '启用';
                    return '禁用';
                }},
            { display:"备注", name:"comment", width:400, type:"text", editor:{ type:'text'} }
        ], dataAction:'server', pageSize:20, toolbar:{},
        url:'<c:url value="/system/dictionary/list"/>', sortName:'id',
    ...
    $("#formsearch").ligerForm({
        fields:[
            {display:"数据源", name:"datasource", newline:true, labelWidth:100, width:220, space:30, type:"text", cssClass:"field", attr:{op:'equal', vt:'int'}}
        ],
        ...
        if (detailWin) {
            ...
            mainform.ligerForm({
                ...
                fields:[
                    ...
                    { display:"备注", name:"comment_", newline:true, labelWidth:100, width:220, space:30, type:"text", align:"left", validate:{ maxlength:100}, editor:{ type:'text'} }
                ],
                toJSON:JSON2.stringify
            });
