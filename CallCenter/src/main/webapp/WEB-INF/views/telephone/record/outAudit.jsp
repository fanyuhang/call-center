...
<script type="text/javascript">
    ...
    var grid = $("#maingrid").ligerGrid({
        ...
        columns: [
            ...
            {display: "总时长(秒)", name: "fldTotalDuration", width: "100", isSort: true},
            {display: "通话时长(秒)", name: "fldCallLong", width: "100", isSort: true},
        ...
        ], dataAction: 'server', pageSize: 20, toolbar: {}, url: '<c:url value="/telephone/record/list"/>?type=0',sortName:'fldCallDate', sortOrder:'desc',
