...
<script type="text/javascript">
	...
	var grid = $("#maingrid").ligerGrid({
	    ...
	    ], dataAction: 'server', pageSize: 20, toolbar: {}, url: '<c:url value="/telephone/record/list"/>?type=1',sortName:'fldCallDate', sortOrder:'desc',
	...
	function toolbarBtnItemClick(item) {
	    ...
	    case "audit":
            ...
            top.f_addTab(null, '呼入审查', '<c:url value="/telephone/record/auditView"/>' + '?menuNo=${menuNo}&fldId=' + selected.fldId);
        	break;
	    }
	}
