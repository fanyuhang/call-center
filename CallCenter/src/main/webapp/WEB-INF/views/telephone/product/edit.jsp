...
<script type="text/javascript">
    ...
    mainform.ligerForm({
        ...
        fields:[
            ...
            { display:'产品名称', name:'fldTitle', attr:{value:'${notice.fldTitle}'}, validate:{ required:true, maxlength:500 }, newline:true, type:"text", group:"基本信息", groupicon:'<c:url value="/static/ligerUI/icons/32X32/communication.gif"/>'},
