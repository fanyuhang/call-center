...
<script type="text/javascript">
  ...
  $("#dialHistory").ligerGrid({
	...
	callMainform.ligerForm({
        ...
        inputWidth:150,
        fields:[
            {display:"通话开始时间", name:"fldCallBeginTime", newline:true, type:"text",attr:{readonly:"readonly"},format:'yyyy-MM-dd hh:mm:ss'},
    ...
    var date = new Date();
    $("#fldCallBeginTime").val(date.getFullYear()+"-"+parseInt(parseInt(date.getMonth())+1)+"-"+date.getDate()+" "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds());
