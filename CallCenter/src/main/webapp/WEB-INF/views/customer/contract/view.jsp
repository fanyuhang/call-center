...
<script type="text/javascript">
    ...
    mainform.ligerForm({
        ...
        fields: [
            ...
            {display: "业绩系数", name: "fldPerformanceRadio", attr:{value:"${customerContract.fldPerformanceRadio}",readonly: "readonly"}, newline: true, type: "float",group: "<label style=white-space:nowrap;>业绩信息</label>", groupicon: '<c:url value="/static/ligerUI/icons/32X32/communication.gif"/>'},
            {display: "业绩额度", name: "fldPerformanceMoney", attr:{value:"${customerContract.fldPerformanceMoney}",readonly: "readonly"}, newline: false, type: "float"},
            {display: "佣金系数", name: "fldCommissionRadio", attr:{value:"${customerContract.fldCommissionRadio}",readonly: "readonly"}, newline: true, type: "float",group: "<label style=white-space:nowrap;>佣金信息</label>", groupicon: '<c:url value="/static/ligerUI/icons/32X32/communication.gif"/>'},
            {display: "佣金金额", name: "fldCommissionMoney", attr:{value:"${customerContract.fldCommissionMoney}",readonly: "readonly"}, newline: false, type: "float"},
