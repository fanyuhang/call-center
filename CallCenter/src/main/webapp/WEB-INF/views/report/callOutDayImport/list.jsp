...
//            {display: "通话时长 <", name: "totalCallLongEnd", newline: false, cssClass: "field", type: "text", attr: {"op": 'less',"type":'int'}},
            {display: "话单名称", name: "importName", newline: true, cssClass: "field", type: "text", attr: {"op": 'like'}},
    ...
    var grid = $("#maingrid").ligerGrid({
        ...
        columns: [
            ...
            { display: "话单名称", name: "importName", type: "text", align: "center" },
        ...
        ], dataAction: 'server', toolbar: {}, url: '<c:url value="/report/callOutDayImport/list"/>',
    ...
    function f_export(columnNames, propertyNames) {
        ...
        LG.ajax({
            loading: '正在导出数据中...',
            url: '<c:url value="/report/callOutDayImport/export"/>',
