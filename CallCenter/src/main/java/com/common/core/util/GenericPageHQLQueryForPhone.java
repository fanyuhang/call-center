...
public class GenericPageHQLQueryForPhone<T> {
    @PersistenceContext(unitName="phoneDefaultPU")
    ...
    private Logger logger = Logger.getLogger(GenericPageHQLQueryForPhone.class);

    public GenericPageHQLQueryForPhone() {
