...
public class Constant {
    ...
    public static final String FILTER_OP_ISNULL = "isnull";           //查询条件操作符----  is null

    public static final String FILTER_OP_ISNOTNULL = "isnotnull";    //查询条件操作符----  is not null
    ...
    public static final String FILTER_OP_STARTWITH = "startwith";    //查询条件操作符----  like

    public static final String FILTER_OP_ENDWITH = "endwith";        //查询条件操作符----  like
    ...
    public static final String FILTER_TYPE_FLOAT = "float";        //查询条件数据类型----  float

    public static final String FILTER_TYPE_LONG = "long";          //查询条件数据类型----  long

    public static final String FILTER_TYPE_NUMBER = "number";      //查询条件数据类型----  number

    public static final String FILTER_TYPE_DATE = "date";           //查询条件数据类型----  date

    public static final String FILTER_TYPE_STRING = "string";      //查询条件数据类型----  string

    public static final String FILTER_CONTEXT_USERID = "{CurrentUserID}"; //查询条件用户变量----  用户ID

    public static final String FILTER_CONTEXT_ROLEID = "{CurrentRoleID}"; //查询条件用户变量----  角色ID

    public static final String FILTER_CONTEXT_DEPTID = "{CurrentDeptID}"; //查询条件用户变量----  部门代码
    //-------------------------------end filter-----------------------------------------------
    ...
    public static final Integer RISK_RECORD_OBJECT_TYPE_MERCHANT = 1;       //可疑交易对象类型 商户
    public static final Integer RISK_RECORD_OBJECT_TYPE_CARD = 2;           //可疑交易对象类型 卡
    public static final Integer RISK_RECORD_OBJECT_TYPE_CUSTOMER = 3;      //可疑交易对象类型 客户

    public static final Integer ORDER_INVOICE_STATUS_NOT_AUDITED = 0;       //发票状态  未复核
    ...
    public static final Integer MERCHANT_PAYMENT_STATUS_NOT_AUDIT = 0;      //付款审核状态 待复核
    public static final Integer MERCHANT_PAYMENT_STATUS_AUDITED = 1;        //付款审核状态 已复核
    public static final Integer MERCHANT_PAYMENT_STATUS_CANCELED = 2;       //付款审核状态 已取消
    ...
    public static final Integer ORDER_RECEIPT_STATUS_NOT_AUDIT = 0;    //收款审核状态, 未审核
    public static final Integer ORDER_RECEIPT_STATUS_NOT_PASS = 1;     //收款审核状态, 审核未通过
    public static final Integer ORDER_RECEIPT_STATUS_PASS = 2;         //收款审核状态, 审核已通过

    public static final Integer ORDER_RECEIPT_CANCEL_STATUS_NOT_AUDIT = 0; //收款取消审核状态, 未审核
    public static final Integer ORDER_RECEIPT_CANCEL_STATUS_NOT_PASS = 1;  //收款取消审核状态, 审核未通过
    public static final Integer ORDER_RECEIPT_CANCEL_STATUS_PASS = 2;       //收款取消审核状态, 审核已通过
