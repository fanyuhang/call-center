...
import com.common.mybatis.paginator.domain.Order;
 ...
 */
@Controller
@RequestMapping(value = "/report/yeJiDay")
public class YeJiDayController {
    private Logger logger = LoggerFactory.getLogger(YeJiDayController.class);
    @Autowired
    ...
    public String init(String menuNo, Model model) {
        ...
        return "report/yeJiDay/list";
    }

    private List<YeJiDay> getList(String where, GridPageRequest pageRequest) {
        ...
        try {
            ...
            return reportMybatisManager.yeJiDay(param);
        } catch (Exception e) {
            e.printStackTrace();
            logger.error(e.getMessage());
        }
        return new PageList<YeJiDay>();
    }

    @RequestMapping(value = "list")
    @ResponseBody
    public DataResponse<YeJiDay> list(String where, GridPageRequest pageRequest) {
        List<YeJiDay> pageList = getList(where, pageRequest);
        DataResponse<YeJiDay> dataResponse = new DataResponse<YeJiDay>(pageList);
    ...
    public AsyncResponse export(String where, String columnNames, String propertyNames, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            ListToExcel<YeJiDay> listToExcel = new ListToExcel<YeJiDay>(getList(where, null), columnList, propertyList, "sheet1");
