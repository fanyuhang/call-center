...
import com.redcard.report.entity.CallOutDayImport;
 ...
 */
@Controller
@RequestMapping(value = "/report/callOutDayImport")
public class CallOutDayImportController {
    private Logger logger = LoggerFactory.getLogger(CallOutDayImportController.class);
    @Autowired
    ...
    public String init(String menuNo, Model model) {
        ...
        return "report/callOutDayImport/list";
    }

    private List<CallOutDayImport> getList(String where, GridPageRequest pageRequest) {
        ...
        try {
            ...
            return reportMybatisManager.callOutDayImport(param);
        } catch (Exception e) {
            e.printStackTrace();
            logger.error(e.getMessage());
        }
        return new PageList<CallOutDayImport>();
    }

    @RequestMapping(value = "list")
    @ResponseBody
    public DataResponse<CallOutDayImport> list(String where, GridPageRequest pageRequest) {
        List<CallOutDayImport> pageList = getList(where, pageRequest);
        DataResponse<CallOutDayImport> dataResponse = new DataResponse<CallOutDayImport>(pageList);
    ...
    public AsyncResponse export(String where, String columnNames, String propertyNames, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            ListToExcel<CallOutDayImport> listToExcel = new ListToExcel<CallOutDayImport>(getList(where, null), columnList, propertyList, "sheet1");
