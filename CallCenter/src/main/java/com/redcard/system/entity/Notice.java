...
/**
 * Created by thinkpad on 15-2-11.
 */
@Entity
@Table(name = "TBLNOTICE")
public class Notice implements Serializable {

    private static final long serialVersionUID = 8604034672751494514L;
    ...
    public boolean equals(Object o) {
        ...
        if (fldContent != null ? !fldContent.equals(notice.fldContent) : notice.fldContent != null) return false;
        if (fldCreateDate != null ? !fldCreateDate.equals(notice.fldCreateDate) : notice.fldCreateDate != null)
            return false;
        if (fldCreateUserNo != null ? !fldCreateUserNo.equals(notice.fldCreateUserNo) : notice.fldCreateUserNo != null)
            return false;
        if (fldId != null ? !fldId.equals(notice.fldId) : notice.fldId != null) return false;
        if (fldLevel != null ? !fldLevel.equals(notice.fldLevel) : notice.fldLevel != null) return false;
        if (fldOperateDate != null ? !fldOperateDate.equals(notice.fldOperateDate) : notice.fldOperateDate != null)
            return false;
        if (fldOperateUserNo != null ? !fldOperateUserNo.equals(notice.fldOperateUserNo) : notice.fldOperateUserNo != null)
            return false;
        if (fldStatus != null ? !fldStatus.equals(notice.fldStatus) : notice.fldStatus != null) return false;
        if (fldTitle != null ? !fldTitle.equals(notice.fldTitle) : notice.fldTitle != null) return false;
