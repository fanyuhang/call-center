...
/* Created on:     2016-04-18 15:32:03                          */
/*==============================================================*/
...
if exists (select 1
            from  sysobjects
           where  id = object_id('tblTelephoneImportTemp')
            and   type = 'U')
   drop table tblTelephoneImportTemp
go
...
create table tblTelephoneAssign (
   ...
   fldRecoverStatus     int                  null,
   fldRecoverDate       datetime             null,
   fldRecoverUserNo     nvarchar(32)         null,
...
/*==============================================================*/
/* Table: tblTelephoneImportTemp                                */
/*==============================================================*/
create table tblTelephoneImportTemp (
   fldId                bigint               identity,
   fldBatchNo           nvarchar(40)         null,
   ...
   fldCreateUserNo      nvarchar(32)         null,
   fldCreateDate        datetime             null,
   constraint PK_TBLTELEPHONEIMPORTTEMP primary key (fldId)
)
go
